...
function load_syllabusmaker_scripts() {
	wp_dequeue_script( 'autosave' );
}	
add_action('admin_enqueue_scripts', 'load_syllabusmaker_scripts');	
...
class KPS_GreenCard {
	...
	function gc_deal_expiration(){
      ...
      <script>
      	jQuery(function() {
	      jQuery( "#gc_deal_start" ).datepicker();
		  jQuery( "#gc_deal_end" ).datepicker();
    	});
      </script>
